...
correct_ids = [2146868174, 2080007427, 3723934386, 1542670640, 1856465875, 3865350209, 1438614044, 1321411427, 3163580623, 112935500, 63923053, 19172132, 1631297309, 3766243856, 4078919784, 2634044089]
for i in range(16):
	print(new_client("127.0.0.1", 5065 + i).call("get_info"))
	if get_id(5065 + i) != correct_ids[i]:
		print("incorrect id.")
		exit(0)
