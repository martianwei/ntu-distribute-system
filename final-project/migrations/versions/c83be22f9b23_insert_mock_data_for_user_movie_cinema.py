...
def upgrade():
    ...
    op.execute(
        ...
        ', 'https://i.imgur.com/eeS6oS7.jpg'),
            ('復仇者聯盟：終局之戰', '01:45:00', 'Drama', '《復仇者聯盟：終局之戰》大結局中，分別代表聯盟中兩大力量的主角都離開了，鋼鐵人光榮犧牲，美國隊長交棒給獵鷹。儘管昔日聯盟中很多超級英雄依然活在地球上，或是像驚奇隊長那樣還在宇宙中各自打拼，但就在態勢如此四分五裂時，漫威宣布啟動兩部《復仇者聯盟》續集《Kang Dynasty 》和《Secret Wars》，場子撐的起來嗎？又有那些超級英雄會雀屏中選出演呢？首先，就像我們在《雷神索爾：愛與雷霆》中看到的，雷神索爾自己要忙於保護新的阿斯加德星球來抵抗屠神者戈爾的來擊，又比如超級英雄們都不記得彼得·帕克（《蜘蛛人：無家日》結尾，雖然英雄們記得蜘蛛人，但是奇異博士讓整個世界忘記「彼得帕克」真人地的存在）。但是，漫威宇宙第四階段倒是出現了一些令人興奮的新人。例如，《奇異博士2：失控的多重宇宙》中，能力強大的多重宇宙穿越者「美國小姐」（America Chavez），還有大師兄「王」Wong，；《黑豹2：瓦干達萬歲》中，Riri「鋼鐵心」則是個驚喜，還有接替死去黑豹的「黑豹妹舒莉」，這些無疑都是會是漫威宇宙第五階段力捧的英雄人物，他們的組合也無疑符合當前時代的種族與性別多元性。
        ', 'https://i.imgur.com/FxwHKxS.jpg'),
            ('玩命關頭十', '02:15:00', 'Comedy', '《玩命關頭》系列的第十部電影，唐老大（馮迪索 飾）這些年來曾經執行許多看似不可能的任務，他和他的家人遇到的每一個對手都比他們更聰明、更冷酷無情和更會飆車。現在，他們必須面對有史以來最致命的對手：一個從過去的陰影中冒出來的可怕威脅，他為了報仇雪恨下定決心要永遠摧毀這個家庭，以及唐老大所愛的每一個人和所有的一切。唐老大和他的夥伴在2011年的《玩命關頭5》一片中，除掉了惡名昭彰的巴西大毒梟赫南芮斯，並且在里約熱內盧的一座橋上徹底瓦解他的販毒帝國。但是他們卻不知道芮斯的兒子但丁（《水行俠》傑森摩莫亞 飾）親眼目睹了那一切，而且在過去的12年之間精心策劃了一個復仇計畫，目的是要讓唐老大付出終極代價。
        ...
        ', 'https://i.imgur.com/zuyzCQ3.jpg'),
            ('駭客任務', '01:50:00', 'Thriller', '這是一部融合東方武術與西方電影特效的影片。導演拉娜華卓斯基與莉莉華卓斯基說：「我們想表達的概念是，現代人所相信的世界以及其中的一切，其實都是未來電腦所創造的。一旦你進入所謂的電腦虛擬實境，就可以發揮人類在各方面的極限，所以片中的人物只要接收足夠的資料，就能成為跟成龍一樣的功夫高手。本片描述二十二世紀一名電腦代號為尼歐(基努李維飾演)的電腦駭客，他總是覺得世界一切都不對勁，但卻又說不出所以然來。常常在夢中、或電腦中都會有個聲音對他說話，讓他分不清真實與夢境的界限。直到他來到地下自由鬥士的組織，才真相大白。於是他和一群身懷絕技的鬥士，開始展開對抗控制全體人類的『電腦魔王』的使命……
        ', 'https://i.imgur.com/Zcti0R2.jpg'),
            ('西遊記之大聖歸來', '02:05:00', 'Romance', '《西遊記之大聖歸來》故事聚焦在大鬧天宮的五百年後，重新改編三藏與孫悟空的相遇。讓失親的小沙彌救了被壓在五行山下的孫悟空，儘管小沙彌的名字叫江流兒，但致敬《大話西遊》中聒噪愛問煩人唐僧的性格，足以讓人一看便知（官方設定上小沙彌為唐僧的前世）。故事雖然簡單、通俗、結尾還有些灑狗血，但讓孫悟空失去法力、面對小沙彌崇拜卻又硬撐愛面子的設定不但有趣也讓齊天大聖有了血肉與人性，似乎也舖成了原著甚至未來續集中師徒二人的情感。（話說這動畫裡面有八戒、有白龍王，卻沒有沙悟淨，這些跡象可看出電影意欲開啟系列電影目的明顯）。
